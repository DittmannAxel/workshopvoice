...
See [voicewithagents/README.md](voicewithagents/README.md) for a minimal Python script that connects to Azure VoiceLive and uses an **existing** agent stored in AI Foundry (no agent creation). The agent id is typically `agentName:version` (example: `agentFeborder:8`).
